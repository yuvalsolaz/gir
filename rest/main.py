...
from model.geolabel import get_token_rects, get_token_polygons
from model.knn import SearchEngine
...
@app.get("/geoknn", response_model=List[GeocodeResults])
def geoknn(text: str, k=5):
